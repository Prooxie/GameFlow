...
using Autofire.Infrastructure.Runtime.Slots;
...
public sealed class SlotsViewModel : ViewModelBase, IDisposable
{
    ...
    public SlotsViewModel(SlotRegistry registry, InputDeviceCatalog catalog, DeviceTemplateStore templateStore, ProfileSession profileSession, Autofire.Infrastructure.Localization.ILocalizationService localization)
    {
