...
/// on <see cref="Autofire.Infrastructure.Profiles.AppSettings"/> instead.
/// </para>
/// </summary>
...
/// <see cref="Autofire.Infrastructure.Updates.UpdateCheckResult.Failed"/>
...
public sealed class UpdateOptions
{
    ...
    /// the README (e.g. <c>"Autofire-Next-v1.2.3-win-x64.zip"</c>).
    /// </summary>
    public string AssetNamePattern { get; set; } = "Autofire-Next-{tag}-{rid}.zip";
    ...
    /// </summary>
    public string UserAgent { get; set; } = "Autofire-Next-UpdateChecker";
}
